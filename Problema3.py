...
Npayasos= int(input("Introduzca la cantidad de los jueguetes de payasos: "))
Nmunecas = int(input("Introduzca la cantidad de los juguetes de muniecas: "))

PesoTotal = Npayasos*112 + Nmunecas*75

print("El peso total registrado es " + str(PesoTotal))
